...
public class Vampire implements Kit {
    ...
    public ItemStack[] getArmor() {
        ...
        meta.setOwner("VulScorpio");
        skull.setItemMeta(meta);

        return new ItemStack[]{
                new ItemBuilder(skull).name("&fVampire's Head").unbreakable(true).build(),
                new ItemBuilder(Material.LEATHER_CHESTPLATE).color(Color.GRAY).unbreakable(true).build(),
    ...
    public String[] getDescription() {
        return new String[]{
                ...
                "&7Defense: &f5.0",
                "",
                "&7Drain effects of other players."
        };
    }
